...
This is a .NET 10 WinForms application that demonstrates features of the [CP-IO22](https://comfiletech.com/raspberry-pi-panel-pc/cp-io22-i-o-board-accessory-for-the-cpi-s-series/) IO board for the [ComfilePi industrial touchscreen panel PCs](https://comfiletech.com/linux-panel-pc/), and how to program it.
...
Both the `ComfileTech.ComfilePi.CP_IO22.Demo` project and the `ComfileTech.ComfilePi.CP_IO22` project now target .NET 10.
...
1. Right-click the `ComfileTech.ComfilePi.CP_IO22.Demo` project and choose **Publish**.
